...
execute if entity @s[nbt=!{Dimension:"minecraft:overworld"}] if entity @s[nbt=!{Dimension:"minecraft:the_nether"}] if entity @s[nbt=!{Dimension:"minecraft:the_end"}] run tellraw @s {text:'You can\'t execute this command here',color:red}
