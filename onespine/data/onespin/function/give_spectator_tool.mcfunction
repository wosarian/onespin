...
give @s minecraft:feather[item_name={"text":"OS Spectator Tool"},rarity=epic,item_model="onespin:spectator_tool",consumable={consume_seconds:2147483647,animation:bow,has_consume_particles:0b,nutrition:1,saturation:1},custom_data={OS-spectatorTool:true},max_stack_size=1]
