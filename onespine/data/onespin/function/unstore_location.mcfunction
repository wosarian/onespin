...
execute if entity @s[scores={grenadier-playerPermissionLevel=..1}] run tellraw @s [{"text":"Requires minimum permission level to be 2 or more","color":"red"}]
execute if entity @s[scores={grenadier-playerPermissionLevel=..1}] run return fail
