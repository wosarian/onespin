...
scoreboard objectives modify setHome displayname "Set Home Location"
scoreboard objectives add home trigger
scoreboard objectives modify home displayname "Teleport To Home"
scoreboard objectives add h trigger
scoreboard objectives modify h displayname "Teleport To Home"
